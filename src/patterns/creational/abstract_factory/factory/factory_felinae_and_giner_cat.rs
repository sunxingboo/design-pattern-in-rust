...
use crate::patterns::creational::abstract_factory::product::product_british_shor_hair_cat::FelinaeCat;
use crate::patterns::creational::abstract_factory::product::product_pastoral_cat::GingerCat;
